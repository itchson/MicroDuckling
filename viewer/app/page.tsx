...
export default function Home(){
  ...
  return <main className="cad-app">
    ...
    <header className="topbar"><div className="brand"><img className="brand-logo" src="/brand/microduckling-mascot.png" alt=""/><div><strong>MicroDuckling</strong><span>R08 prototype · {data?.revision??'CAD'}</span></div></div>
