...
|---|---|
| Mechanical native CAD, printed-part exports and original mechanical viewer meshes | Apache-2.0. These exports exclude the two separately supplied electronics visuals. |
| `components/meshes/IMU.json` | CC-BY-SA-3.0 adaptations of Adafruit PCB designs. |
| `components/meshes/Buck_0.json` | Apache-2.0 original visual approximations of Pololu regulators, authored from dimensions and generic primitives; not conversions of manufacturer STEP files. |
