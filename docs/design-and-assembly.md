...
R05 is a four-servo prototype with two rigid leg/rocker-foot prints, a faceted torso, neck yaw and a moving jaw. Physical assembly, printed strength and powered operation remain unverified. Start with the [measurement worksheet](hardware-measurements.md) and [BOM](bom.md).
...
The torso is 76 × 78 × 37 mm. The head is 52 mm wide across the face, 64 mm deep and 52 mm high. PCA9685, both regulators, the IMU and battery sit in the torso; ESP32-CAM, the separate flex camera and mouth servo occupy the head. The nominal assembly envelope is 76 × 112 × 136 mm.
...
3. Fit the front PCA9685 and horizontal D24V10F5 cradle. The latter slides through the open side and needs an insulating retention method; do not drill its PCB or rely on wires to hold it.
...
7. Assemble the loose hood and face as a removable module. Four face screws enter from the rear; their straight access paths require the hood to be off the populated head frame. Align and retain the camera without stressing its flex.
...
See [R05 refinement](r05-assembly-refinement.md), [engineering review](engineering-review.md) and [simulation](simulation.md) for evidence and remaining work.
